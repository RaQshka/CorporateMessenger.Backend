...
public class GetUsersQueryHandler : IRequestHandler<GetUsersQuery, List<UserFullDetailsDto>>
{
    ...
    public async Task<List<UserFullDetailsDto>> Handle(GetUsersQuery request, CancellationToken cancellationToken)
    {
