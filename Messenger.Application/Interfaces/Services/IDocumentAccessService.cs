...
{
    Task GrantAccessAsync(Guid documentId, Guid roleId, DocumentAccess accessFlag, CancellationToken ct);
    Task RevokeAccessAsync(Guid documentId, Guid roleId, DocumentAccess accessFlag, CancellationToken ct);
